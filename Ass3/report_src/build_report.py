...
D["SECOND"] = tex(ranked[1][0])
D["SECONDACC"] = f"{ranked[1][1]:.3f}"
D["THIRD"] = tex(ranked[2][0])
D["THIRDACC"] = f"{ranked[2][1]:.3f}"
...
clear weakness is @WORST@ at @WORSTACC@, which is confused with @CONFB@ in both directions
