...
SOURCE = f"{BASE}/report/project6_report.tex"
...
pages = subprocess.run([f"{TEXBIN}/pdfinfo.exe", f"{BASE}/report/project6_report.pdf"],
...
if not overfull and count == "2":
    ...
    shutil.copyfile(f"{BASE}/report/project6_report.pdf",
                    f"{BASE}/submission/project6_report.pdf")
    print("  copied to submission/project6_report.pdf")
